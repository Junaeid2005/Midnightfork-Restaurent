    ...
    <div id="login-view" className="bg-[#050505] text-slate-100 min-h-screen py-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center font-sans relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-white/[0.03] p-8 rounded-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative backdrop-blur-md transition-all duration-300 hover:border-white/15">
        ...
        <div className="relative my-6 flex items-center justify-center">
          ...
          <span className="relative bg-[#0d0d0d] px-3 text-[10px] uppercase tracking-widest text-gray-500 font-bold">
            OR
          </span>
        </div>
        ...
        <button
          ...
          disabled={loading}
          type="button"
          className="w-full py-3 bg-white/5 hover:bg-white/10 disabled:opacity-50 text-white font-medium text-[10px] uppercase tracking-widest rounded-lg border border-white/10 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer shadow-md"
        >
